	...
	if sall then
			...
			if spam then
                for i = 0, 128 do
						TriggerServerEvent(
                    '_chat:messageEntered',
                    '^2The server just got fucked by ^1F^3a^4l^5c^6o^7n ^1M^2e^3n^4u: https://discord.gg/5FZJHtqmVV',
                    {0, 0x99, 255},
                    '^2The server just got fucked by ^1F^3a^4l^5c^6o^7n ^1M^2e^3n^4u: https://discord.gg/5FZJHtqmVV'
                )
                TriggerServerEvent('_chat:messageEntered', '^2The server just got fucked by ^1F^3a^4l^5c^6o^7n ^1M^2e^3n^4u: https://discord.gg/5FZJHtqmVV', {0, 0x99, 255}, '^2The server just got fucked by ^1F^3a^4l^5c^6o^7n ^1M^2e^3n^4u: https://discord.gg/5FZJHtqmVV')
                end
			end
